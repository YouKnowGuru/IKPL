      ...
      >
        ...
        <div className="p-3 sm:p-5">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-0">
            <span className="font-display font-bold text-base sm:text-xl text-agro-green">
              {product.price && product.price > 0 ? `Nu. ${product.price.toFixed(0)}` : ''}
            </span>
            <button
              onClick={handleAdd}
      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <div className="absolute inset-0 overflow-hidden">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-tr from-zinc-950 via-transparent to-agro-green/10" />
